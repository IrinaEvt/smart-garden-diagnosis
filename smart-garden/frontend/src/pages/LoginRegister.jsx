...
export default function LoginRegister() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black text-white">
      ...
      {/* Основен flex контейнер с разменяне на половинките */}
      <div className={`flex w-full h-full transition-all duration-700 ease-in-out ${isLogin ? 'flex-row' : 'flex-row-reverse'}`}>

        {/* Лява страна – формата */}
        <div className="w-1/2 h-full flex items-center justify-center p-12 bg-black transition-all duration-700">
          <div className="w-full max-w-md">
            <h2 className="text-4xl font-bold mb-4">{isLogin ? 'Вход' : 'Регистрация'}</h2>
            <p className="text-sm text-gray-400 mb-8">
              {isLogin ? 'Влез в профила си.' : 'Създай акаунт, за да използваш платформата.'}
            </p>
